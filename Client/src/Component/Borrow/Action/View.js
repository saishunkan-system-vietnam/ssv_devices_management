            ...
            <div className="col-xs-10 col-sm-10 col-md-10 col-lg-10 ml-70 pl-30">
                ...
                <div className="row  mt-10">
                    <div className="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                        {borrow.BorrowDevicesDetail && Number(borrow.BorrowDevicesDetail.status) === 0 ? <Link to={`/borrow/edit/${borrow.id}`} className="btn btn-primary">Cập nhập</Link> : ""}
                        ...
                        <Link to="/borrow" className="btn btn-warning ml-10">Hủy</Link>
                    </div>
                </div>
            </div>
        </div>
