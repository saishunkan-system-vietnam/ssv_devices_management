    ...
    return (
        <tr>
            ...
            <td>
                ...
                {Number(props.status_code) === 0 && localStorage.getItem('newUser') &&  JSON.parse(localStorage.getItem('newUser')).role==='Project Manager' ? <i onClick={onApprove} className="fa fa-check-circle fa-lg" > </i> : ''}
                {Number(props.status_code) === 0 && localStorage.getItem('newUser') &&  JSON.parse(localStorage.getItem('newUser')).role==='Project Manager' ? <i onClick={onNoApprove} className="fas fa-times-circle fa-lg" > </i> : ''}
                {Number(props.status_code) === 3 && localStorage.getItem('newUser') &&  JSON.parse(localStorage.getItem('newUser')).role==='Project Manager' ? <i onClick={confirmReturnDevice} className="far fa-calendar-check fa-lg"></i> : ''}
