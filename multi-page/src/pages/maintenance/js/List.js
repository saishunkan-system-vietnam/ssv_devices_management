...
import MaintenanceList from '../../../api/Maintenance/maintenanceList';
import MaintenanceDelete from '../../../api/Maintenance/maintenanceDelete';
import MaintenanceConfirmNotification from '../../../api/Maintenance/maintenanceConfirmNotification';
import MaintenanceNoConfirmNotification from '../../../api/Maintenance/maintenanceNoConfirmNotification';
import MaintenanceFilter from '../../../api/Maintenance/maintenanceFilter';
...
function ListBorrow(props) {
    ...
    function set_show(show, ID = null) {
        props.set_show(show, ID);
    }
        ...
        <div>
            <div className="row filter">
                ...
                <div className="col-xs-2 col-sm-2 col-md-2 col-lg-2">
                    <button onClick={()=>{props.set_show(1)}} className="btn btn-primary mr-10 mt-10"><i className="fa fa-plus"></i> Thêm mới</button>
                </div>
