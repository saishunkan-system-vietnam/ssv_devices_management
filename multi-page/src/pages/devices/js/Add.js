...
import GetCategories from '../../../api/Categories/listcategories';
import GetBrands from '../../../api/Brand/brandsList';
import DeviceAdd from '../../../api/Devices/deviceAdd';
import DeviceEdit from '../../../api/Devices/deviceEdit';
import GetDevice from '../../../api/Devices/deviceView';
...
function Add(props) {
    ...
    useEffect(() => {
        ...
        if (!device && props.id) {
            GetDevice.DeviceView(props.id).then(res => {
