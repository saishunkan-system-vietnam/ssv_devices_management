...
import DeviceView from '../../../api/Devices/deviceView';
...
function View(props) {
    ...
    useEffect(() => {
        if (props.id && !device) {
            DeviceView.DeviceView(props.id).then(res => {
            ...
            <div className="col-xs-10 col-sm-10 col-md-10 col-lg-10 ml-70 pl-30">
                ...
                <div className="row  mt-20">
                    <div className="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                        {device ? <button onClick={() => { props.set_show(3, device.id) }} className="btn btn-primary">Cập nhập</button> : ''}
