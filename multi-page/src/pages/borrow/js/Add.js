...
import BorrowAdd from "../../../api/Borrow/borrowAdd";
import ListDevice from "../../../api/Devices/deviceList";
import ListBrands from '../../../api/Brand/brandsList';
...
import BorrowEdit from '../../../api/Borrow/borrowEdit';
...
function Add(props) {
    ...
    useEffect(() => {
        ...
        if (props.id && borrow.length === 0) {
            BorrowView.BorrowView(props.id).then(res => {
