...
import NotificationBroken from '../../../api/Maintenance/notificationBroken';
import DevicesView from '../../../api/Devices/deviceView';
...
function Add(props) {
    ...
    useEffect(() => {
        if (props.id) {
            if (!device) {
                DevicesView.DeviceView(props.id).then(res => {
    ...
    return (
        <div className="row p-20">
            <div className="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <form>
                    <legend className="pl-30">Thông báo hỏng thiết bị</legend><hr />
