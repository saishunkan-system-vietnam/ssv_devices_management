                ...
                <div className="container-fluid">
                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-6">
                            <div className="au-card au-card--no-shadow au-card--no-pad m-b-40">
                                <div className="au-card-title"
                                     style={{backgroundImage:"url('images/bg-title-02.jpg')"}}>
                                    <div className="bg-overlay bg-overlay--blue"></div>
                                    <h3>
                                ...
                                <div className="au-inbox-wrap js-inbox-wrap">
                                    <div className="au-message js-list-load">
                                                    ...
                                                    <div className="au-message__item-text">
                                                        <div className="avatar-wrap">
                                                            <div className="avatar">
                                                                <img src={require('../../components/images/icon/avatar-02.jpg')}
                                                                     alt="John Smith" />
                                                            </div>
                                                        </div>
                                                        <div className="text">
                                                ...
                                                <div className="au-message__item-inner">
                                                    <div className="au-message__item-text">
                                                        <div className="avatar-wrap online">
                                                            <div className="avatar">
                                                                <img src={require('../../components/images/icon/avatar-03.jpg')}
                                            ...
                                            <div className="au-message__item">
                                                <div className="au-message__item-inner">
                                                    <div className="au-message__item-text">
                                                        <div className="avatar-wrap online">
                                                            <div className="avatar">
                                                                <img src={require('../../components/images/icon/avatar-04.jpg')}
                                                                     alt="Michelle Sims" />
                                                            </div>
                                                        </div>
                                                        <div className="text">
                                            ...
                                            <div className="au-message__item">
                                                <div className="au-message__item-inner">
                                                    <div className="au-message__item-text">
                                                        <div className="avatar-wrap">
                                                            <div className="avatar">
                                                                <img src={require('../../components/images/icon/avatar-05.jpg')}
                                                                     alt="Michelle Sims" />
                                                            </div>
                                                        </div>
                                                        <div className="text">
                                        ...
                                        <div className="au-message__footer">
                                            <button className="au-btn au-btn-load js-load-btn">load more
                                            </button>
                                        </div>
                                    </div>
                                    <div className="au-chat">
                                            ...
                                            <div className="au-chat-info">
                                                <div className="avatar-wrap online">
                                                    <div className="avatar avatar--small">
                                                        <img src={require('../../components/images/icon/avatar-02.jpg')} alt="John Smith" />
                                                    </div>
                                                </div>
                                                <span className="nick">
                                                    <a href={"/"}>John Smith</a>
                                            ...
                                            <div className="recei-mess-wrap">
                                                ...
                                                <div className="recei-mess__inner">
                                                    ...
                                                    <div className="recei-mess-list">
                                                        <div className="recei-mess">Lorem ipsum dolor sit amet,
                                                            consectetur adipiscing elit non iaculis
                                                        </div>
                                                        <div className="recei-mess">Donec tempor, sapien ac
                                                            viverra
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div className="send-mess-wrap">
                                                ...
                                                <div className="send-mess__inner">
                                                    <div className="send-mess-list">
                                                        <div className="send-mess">Lorem ipsum dolor sit amet,
                                                            consectetur adipiscing elit non iaculis
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div className="au-chat-textfield">
                                            <form className="au-form-icon">
                                                <input className="au-input au-input--full au-input--h65"
