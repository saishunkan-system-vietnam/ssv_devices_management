                                                        ...
                                                        <tr>
                                                            <td class="table-col-td" width="530"
                                                                ...
                                                                <div style="font-family: Arial, sans-serif; line-height: 20px; color: #444444; font-size: 13px;">
                                                                    ...
                                                                    <br/>
                                                                    <?php if ($borrowDetail['status'] == 1) { ?>
                                                                        Yêu cầu mượn thiết bị <b><?= $device['name'] ?></b> phục vụ cho việc <b><?= $borrowDetail['borrow_reason'] ?></b> đã được <b>Admin</b> chấp nhận.
                                                                    ...
                                                                    <?php } else if ($borrowDetail['status'] == 2) { ?>
                                                                        Yêu cầu mượn thiết bị <b><?= $device['name'] ?></b> phục vụ cho việc <b><?= $borrowDetail['borrow_reason'] ?></b> đã không được <b>Admin</b> chấp nhận.
                                                                        Bở lý do: <b><?= (empty($borrowDetail['note_admin'])) ? "Thiết bị không có sẵn" : $borrowDetail['note_admin'] ?></b>.
                                                                    <?php } ?>
                                                                    <br/>
                                                                    <br/>
